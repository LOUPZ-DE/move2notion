...
- **Microsoft Graph API 429 Rate-Limiting**: Alle Graph-API-Aufrufe haben jetzt automatisches Retry bei 429- und 5xx-Fehlern (max. 8 Versuche mit exponentiellem Backoff 2–16s). Zuvor fuehrten Rate-Limits zum sofortigen Abbruch ganzer Sections/Notebooks.
